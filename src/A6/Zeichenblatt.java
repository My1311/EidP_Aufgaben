...
public class Zeichenblatt {
     ...
     */
    Zeichenblatt(int breite, int hoehe) {
    ...
    private double remapX(double x) {
        return (xmax - xmin) * (x - bildschirmAusdehnung.left) / breite  + xmin;
    }

    private double remapY(double y) {
     ...
     * @param x x-Koordinate des Punktes
     * @param y y-Koordinate des Punktes
     * @param durchmesser Durcmesser des Punktes in Pixeln
     */
     ...
     * @param winkel Drehwinkelanderung entgegen dem Uhrzeigersinn
     */
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<10; i++)
            zb.punkt((double)i, (double)i, 0.2);
        // Bisheriges anzeigen
        zb.anzeigen();
        // 1 Sekunde warten
        zb.pause(1000);
